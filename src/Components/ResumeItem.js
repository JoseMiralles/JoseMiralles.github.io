...
class ResumeItem extends React.Component {
    ...
    render() {
        ...
        const imgClassNames = item.roundImg ? "left_image img-fluid rounded_image mx-auto my-3" : "left_image img-fluid mx-auto my-3";
        ...
        if (item.links) {
            ...
            imgTag = <img className={imgClassNames} src={item.imgSrc} alt="Resume item"/>;
        }
        ...
        return (
            ...
            <div className="row my-5">
                ...
                <div className="col-md-7">
                    ...
                    {links ? links : ""}
                    {item.description ? <p className="itemDescription">{item.description}</p> : <br/>}
                    <ul>
                        {highlights}
                    </ul>
                </div>
